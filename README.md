...
- `scale_advances.py <bundle> <out> <factor> [ассеты]` — рабочий способ:
  масштабирует `m_HorizontalAdvance` всех глифов. В релизе использован
  коэффициент **0.80** (−20%; v0.0.2 — 0.90, v0.0.3 — 0.85, финально 0.80
  по запросу пользователя). Ниже 0.85 засечки могут касаться — субъективно
  приемлемо, ниже 0.80 уже будут налепы.
