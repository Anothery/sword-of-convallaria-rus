# -*- coding: utf-8 -*-
"""Approximate render: paste rect content at bearing position (0.75 raster),
used only to eyeball glyph consistency between original and baked glyphs."""
import sys
import numpy as np
...
for o in env.objects:
    ...
    for text in lines:
        ...
        for ch in text:
            ...
            pen += m['m_HorizontalAdvance'] * R
        imgs.append(canvas[:, :int(pen) + 40])
    Ht = sum(i.shape[0] for i in imgs) + 20 * len(imgs)
